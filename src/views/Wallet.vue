<template>
  <div class="card-container">
    <van-button plain type="primary" @click="openStudentAuthForm">点击此处进行学生认证</van-button>
    ...
    <div v-for="(card, index) in cards" :key="index" class="card">
      ...
      <!-- <div class="box box1" @click="handleClick('Instagram')">
        <span class="icon">
      ...
      <div class="box box2" @click="handleClick('Twitter')">
        <span class="icon">
      ...
      <div class="box box3" @click="handleClick('Discord')">
        <span class="icon">
      ...
      <div class="box box4" @click="handleClick('Box4')"></div> -->
    </div>
...
const handleClick = (boxName) => {
  switch (boxName) {
    case 'Instagram':
      console.log('Clicked Instagram icon')
      break
    case 'Twitter':
      console.log('Clicked Twitter icon')
      break
    case 'Discord':
      console.log('Clicked Discord icon')
      break
    case 'Box4':
...
// 处理表单提交成功
// 处理凭证添加成功
const handleSubAuthSuccess = async () => {
